...
export default function CoachDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link href="/coach/players" className="bg-white p-5 rounded-xl border border-gray-200 hover:border-emerald-300 transition-colors">
        ...
        <Link href="/coach/sessions" className="bg-white p-5 rounded-xl border border-gray-200 hover:border-blue-300 transition-colors">
        ...
        <Link href="/coach/assignments" className="bg-white p-5 rounded-xl border border-gray-200 hover:border-purple-300 transition-colors">
