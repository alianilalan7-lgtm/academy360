...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Link href="/admin/members" className="bg-white p-5 rounded-xl border border-gray-200 hover:border-emerald-300 transition-colors">
        ...
        <Link href="/admin/groups" className="bg-white p-5 rounded-xl border border-gray-200 hover:border-orange-300 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Link href="/admin/payments" className="bg-yellow-50 p-5 rounded-xl border border-yellow-200 hover:bg-yellow-100 transition-colors">
      ...
      {/* Quick Actions */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link href="/admin/members/invite" className="bg-emerald-50 p-5 rounded-xl border border-emerald-200 hover:bg-emerald-100 transition-colors">
        ...
        <Link href="/admin/payments" className="bg-blue-50 p-5 rounded-xl border border-blue-200 hover:bg-blue-100 transition-colors">
          <div className="text-xl mb-2">💰</div>
          <h3 className="font-semibold text-blue-800">Odeme Kaydet</h3>
          <p className="text-sm text-blue-600">Aidat odemelerini yonetin</p>
        </Link>

        <Link href="/admin/notifications" className="bg-purple-50 p-5 rounded-xl border border-purple-200 hover:bg-purple-100 transition-colors">
          <div className="text-xl mb-2">🔔</div>
